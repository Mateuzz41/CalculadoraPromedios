...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val num1EditText = findViewById<EditText>(R.id.etCalification1)
        val num2EditText = findViewById<EditText>(R.id.etCalification2)
        val num3EditText = findViewById<EditText>(R.id.etCalification3)
